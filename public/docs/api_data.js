define({ "api": [
  ...
  {
    "type": "get",
    "url": "/admin/exports/:type",
    "title": "3.0 Export Data",
    "name": "ExportData",
    "group": "Admin_Broadcast",
    "version": "3.0.0",
    "permission": [
      {
        "name": "Admin"
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "type",
            "description": "<p>Type of data to export (users, blogs, comments)</p>"
          }
        ]
      }
    },
    "description": "<p>Exports data in CSV format.</p>",
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
    ...
    "filename": "routes/admin/broadcast.js",
    "groupTitle": "Admin_Broadcast"
  },
  {
    "type": "get",
    "url": "/admin/broadcasts",
    "title": "2.0 Get All Broadcasts",
    ...
    "description": "<p>Retrieves a paginated list of all broadcasts.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "field": "limit",
            "defaultValue": "10",
            "description": "<p>Number of broadcasts per page</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            ...
            "field": "active",
            "defaultValue": "true",
            "description": "<p>Filter by active status (not expired)</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "description": "<p>Creates and sends a broadcast announcement to users.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "title",
            "description": "<p>Title of the announcement</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "message",
            "description": "<p>Content of the announcement</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "target",
            "description": "<p>Target audience for the announcement (all, top-contributors, admins, specific-users)</p>"
          },
          {
            "group": "Parameter",
            "type": "Array",
            "optional": true,
            "field": "targetUsers",
            "description": "<p>Array of user IDs (required if target is 'specific-users')</p>"
          },
          {
            "group": "Parameter",
            "type": "Date",
            "optional": true,
            "field": "expiresAt",
            "description": "<p>Expiration date for the announcement</p>"
          }
        ]
      },
      "examples": [
