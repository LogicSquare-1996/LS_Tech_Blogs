define({ "api": [
  {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Blog's unique ID</p>"
          }
        ]
      }
    },
    "description": "<p>Soft deletes a blog by setting its isDeleted flag to true.</p>",
    "success": {
      "examples": [
        {
    ...
    "filename": "routes/admin/blogs.js",
    "groupTitle": "Admin_Blogs"
  },
  {
    "type": "delete",
    "url": "/admin/comments/:id",
    "title": "4.0 Delete Comment",
    "name": "DeleteComment",
    "group": "Admin_Blogs",
    "version": "4.0.0",
    "permission": [
    ...
    "description": "<p>Soft deletes a comment by setting its isDeleted flag to true.</p>",
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
  ...
  },
  {
    ...
    "description": "<p>Retrieves a paginated list of all blogs with optional filtering.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "field": "limit",
            "defaultValue": "10",
            "description": "<p>Number of blogs per page</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "search",
            "description": "<p>Search term to filter blogs by title or content</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "status",
            "description": "<p>Filter blogs by status (published, draft)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "author",
            "description": "<p>Filter blogs by author ID</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            ...
            "description": "<p>Field to sort by (createdAt, title, views, likes, comments)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            ...
            "field": "sortOrder",
            "defaultValue": "desc",
            "description": "<p>Sort order (asc, desc)</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "description": "<p>Retrieves a paginated list of all comments with optional filtering.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": true,
            "field": "search",
            "description": "<p>Search term to filter comments by content</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "blogId",
            "description": "<p>Filter comments by blog ID</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "userId",
            "description": "<p>Filter comments by user ID</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            ...
            "field": "sortBy",
            "defaultValue": "createdAt",
            "description": "<p>Field to sort by (createdAt, likes)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  },
  {
    ...
    "title": "1.0 Get Dashboard Statistics",
    ...
    "description": "<p>Retrieves statistics for the admin dashboard.</p>",
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
  ...
  },
  {
    ...
    "description": "<p>This endpoint allows administrators to delete a specific notification from the system.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Notification's unique ID (in URL path)</p>"
          }
        ]
      }
    },
    "examples": [
      {
        "title": "Example Usage:",
        "content": "curl -X DELETE -H \"Authorization: Bearer xxxx.yyyy.zzzz\" https://api.example.com/admin/notifications/60f5a13d6b1f0e12345abcde",
        "type": "curl"
      }
    ],
    "success": {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "error",
            "description": "<p>Indicates if there was an error (always false for success)</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
        ...
        "403": [
          {
            ...
            "optional": false,
            "field": "error",
            "description": "<p>Error indicator (always true for errors)</p>"
          },
          {
            "group": "403",
            "type": "String",
    ...
    "filename": "routes/admin/notifications.js",
    "groupTitle": "Admin_Notifications"
  },
  {
    "type": "post",
    "url": "/admin/notifications",
    "title": "2.0 Get All Notifications",
    ...
    "description": "<p>This endpoint allows administrators to retrieve all notifications in the system with pagination and filtering options.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "field": "limit",
            "defaultValue": "10",
            "description": "<p>Number of notifications per page</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "type",
            "description": "<p>Filter notifications by type ('new_blog', 'like', 'comment', 'reply', 'system')</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "notifications",
            "description": "<p>Array of notification objects</p>"
          },
          {
            "group": "Success 200",
            "type": "Object",
          ...
          },
          {
            ...
            "description": "<p>Total number of notifications</p>"
          },
          {
            "group": "Success 200",
            "type": "Number",
  ...
  },
  {
    ...
    "title": "1.0 Send System Notification",
    ...
    "description": "<p>This endpoint allows administrators to send system notifications to all users or a specific user.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "message",
            "description": "<p>Content of the notification</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "target",
            "description": "<p>Target audience for the notification (must be 'all' or 'specific_user')</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "targetUser",
            "description": "<p>User ID of the specific user (required when target is 'specific_user')</p>"
          },
          {
            "group": "Parameter",
            "type": "Date",
            "optional": true,
            "field": "expiresAt",
            "description": "<p>Optional expiration date for the notification</p>"
          }
        ]
      }
    },
    "examples": [
      {
        "title": "Request Example - All Users:",
        "content": "{\n  \"title\": \"System Maintenance\",\n  \"message\": \"The system will be down for maintenance on Saturday from 2-4 AM\",\n  \"target\": \"all\"\n}",
        "type": "json"
      },
      {
        "title": "Request Example - Specific User:",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "notification",
            "description": "<p>The created notification object</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "description": "<p>Retrieves a paginated list of all users with optional filtering.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": true,
            "field": "search",
            "description": "<p>Search term to filter users by name or email</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "role",
            "description": "<p>Filter users by role (employee, admin)</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": true,
            "field": "isActive",
            "description": "<p>Filter users by active status</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            ...
            "field": "sortBy",
            "defaultValue": "createdAt",
            "description": "<p>Field to sort by (createdAt, name.first, email)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "role",
            "description": "<p>New role for the user (employee, admin)</p>"
          }
        ]
      },
      "examples": [
    ...
    "description": "<p>Updates a user's role.</p>",
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
  ...
  },
  {
    "type": "get",
    "url": "/awstempcreds",
    "title": "5.0 login user get temporary aws key",
    "name": "GetAwsKey",
    "group": "Auth",
    "version": "1.0.0",
    "header": {
  ...
  },
  {
    ...
    "error": {
      ...
      "examples": [
        ...
        {
          "title": "Error-Response (No pending verification found):",
  ...
  },
  {
    ...
    "title": "4.0 Get Unread Notification Count",
    ...
    "description": "<p>This endpoint retrieves the count of unread notifications for the currently authenticated user.</p>",
    "examples": [
      {
        "title": "Example Usage:",
        "content": "curl -X POST -H \"Authorization: Bearer xxxx.yyyy.zzzz\" https://api.example.com/notifications/unread-count",
        "type": "curl"
      }
    ],
    "success": {
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "unreadCount",
            "description": "<p>Number of unread notifications</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    "type": "post",
    "url": "/notifications",
    "title": "1.0 Get User Notifications",
    ...
    "description": "<p>This endpoint retrieves notifications for the currently authenticated user with pagination and filtering options.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "field": "unreadOnly",
            "defaultValue": "false",
            "description": "<p>Filter to show only unread notifications</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "title": "3.0 Mark All Notifications as Read",
    ...
    "description": "<p>This endpoint marks all notifications as read for the currently authenticated user.</p>",
    "examples": [
      {
        "title": "Example Usage:",
        "content": "curl -X PUT -H \"Authorization: Bearer xxxx.yyyy.zzzz\" https://api.example.com/notifications/read-all",
        "type": "curl"
      }
    ],
    "success": {
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "message",
            "description": "<p>Success message with the number of notifications marked as read</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "title": "2.0 Mark Notification as Read",
    ...
    "description": "<p>This endpoint marks a specific notification as read for the currently authenticated user.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "examples": [
      {
        "title": "Example Usage:",
        "content": "curl -X PUT -H \"Authorization: Bearer xxxx.yyyy.zzzz\" https://api.example.com/notifications/60f5a13d6b1f0e12345abcde/read",
        "type": "curl"
      }
    ],
    "success": {
  ...
  },
  {
    "type": "get",
    "url": "/user/me",
    "title": "1.0 Get Current User Profile",
    ...
    "description": "<p>Retrieves the profile information of the currently authenticated user.</p>",
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
  ...
  },
  {
    "type": "get",
    "url": "/user/profile/:id",
    "title": "4.0 Get Public User Profile",
    ...
    "description": "<p>Retrieves the public profile information of a user by their ID.</p>",
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
  ...
  },
  {
    "type": "get",
    "url": "/user/history",
    "title": "5.0 Get User Reading History",
    "name": "GetUserHistory",
    "group": "User_Profile",
    "version": "5.0.0",
    "permission": [
    ...
    "description": "<p>Retrieves the reading history of the currently authenticated user.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    "type": "put",
    "url": "/user/me",
    "title": "2.0 Update Current User Profile",
    ...
    "description": "<p>Updates the profile information of the currently authenticated user.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "name",
            "description": "<p>User's name object</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": true,
            "field": "gender",
            "description": "<p>User's gender (Male, Female, Other)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": true,
            "field": "social",
            "description": "<p>User's social media profiles</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "title": "3.0 Update Profile Picture",
    ...
    "description": "<p>Returns a pre-signed S3 URL for uploading a profile picture. The client should use this URL to upload the image directly to S3.</p>",
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
